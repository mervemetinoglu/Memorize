...
struct MemoryGame<CardContent> where CardContent: Equatable {
    ...
    struct Card: Equatable, Identifiable, CustomDebugStringConvertible {
        ...
        // this gets smaller and smallet the longer the card remains face up without being matched
        var bonus: Int {
        ...
        // how long this card has evet been face up and unmatched during its lifetime
